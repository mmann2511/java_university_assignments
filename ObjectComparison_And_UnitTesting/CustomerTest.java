...
public class CustomerTest {
    ...
    /** Tests the setLocation1 (1 parameter) method. */
   ...
   /** Tests the setLocation2 (2 parameters) method. */
   ...
   /** Tests the compareTo (if obj are equal) method. */
   ...
   /** Tests the compareTo (if obj1 < obj2) method. */
