 ...
 * @version 10/30/2025
 */
public class Spherocylinder implements 
                          Comparable<Spherocylinder> {
   ...
   /**
    * Compares 2 Spherocylinder Objects.
    * @param obj - seperate Sphero object
    *
    * @return 0 if volumes are equal
    * -1 if obj2 volume is less than obj2
    *  1 if obj1 volume is greater than obj2
    */
